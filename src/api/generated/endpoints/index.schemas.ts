 ...
 */
export type AuditLogOutBefore = { [key: string]: unknown } | null;

/**
 * State after the action.
 */
export type AuditLogOutAfter = { [key: string]: unknown } | null;

export interface AuditLogOut {
  /** Audit log entry ID. */
  id: number;
  /** Dot-namespaced action, e.g. 'hourly_rate.updated'. */
  action: string;
  ...
  actor_role: string;
  /** Full name of the employee affected, if any. */
  target_name?: string | null;
  /** Company the action belongs to. Only populated for the admin cross-company view. */
...
export interface AuditLogsListOut {
...
offset?: number;
/**
 * Admin-only filter; ignored for managers.
 */
